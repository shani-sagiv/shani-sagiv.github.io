...
export const watTempleImages = importAll(
  require.context("./wat-temple", false, /\.(png|jpe?g|svg|webp)$/),
);
export const sundayMarketImages = importAll(
  require.context("./sunday-market", false, /\.(png|jpe?g|svg|webp)$/),
);
export const astraImages = importAll(
  require.context("./astra", false, /\.(png|jpe?g|svg|webp)$/),
);
export const doiSutepImages = importAll(
  require.context("./doi-sutep", false, /\.(png|jpe?g|svg|webp)$/),
);
export const doiPuiImages = importAll(
  require.context("./doi-pui", false, /\.(png|jpe?g|svg|webp)$/),
);

export const cobraImages = importAll(
  require.context("./cobra", false, /\.(png|jpe?g|svg|webp)$/),
);

export const insectZooImages = importAll(
  require.context("./insect-zoo", false, /\.(png|jpe?g|svg|webp)$/),
);

export const sirikitImages = importAll(
  require.context("./sirikit-botanical", false, /\.(png|jpe?g|svg|webp)$/),
);
export const woodCarveImages = importAll(
  require.context("./wood-carve", false, /\.(png|jpe?g|svg|webp)$/),
);
export const stickyWaterfallImages = importAll(
  require.context("./sticky-waterfall", false, /\.(png|jpe?g|svg|webp)$/),
);
...
export const gingerFarmImages = importAll(
  require.context("./ginger-farm", false, /\.(png|jpe?g|svg|webp)$/),
);

export const arcadeImages = importAll(
  require.context("./arcade", false, /\.(png|jpe?g|svg|webp)$/),
);

export const lannaImages = importAll(
  require.context("./lanna", false, /\.(png|jpe?g|svg|webp)$/),
);
